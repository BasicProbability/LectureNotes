...
$$ P(|\mathbb{E}[X] - X| > \epsilon) \leq \dfrac{\sigma^{2}}{\epsilon^{2}} \ . $$ 
\end{Lemma}

\paragraph{Proof of Lemma~\ref{Chebyshev}} 
By Markov's inequality we have that
\begin{equation}
P((\mathbb{E}[X] - X)^{2} > \epsilon^{2}) \leq \dfrac{\sigma^{2}}{\epsilon^{2}} \ .
\end{equation}  
which is of course equivalent what Lemma~\ref{Chebyshev} states.$ \square $ \bigskip
...
&= var(\frac{1}{n} \underset{i=1}{\overset{n}{\sum}} X_{i}) \\
&= \frac{1}{n^{2}}var(\underset{i=1}{\overset{n}{\sum}} X) \\
&= \frac{1}{n^{2}}~n~var(X) = \dfrac{var(X)}{n} \ .
\end{align}
Lemma~\ref{Chebyshev} then implies that 
\begin{equation}
\underset{n \rightarrow 0}{\lim}P(|\mathbb{E}[X] - \overline{\mu}| < \epsilon) \leq \frac{\sigma^{2}}{n\epsilon^{2}} \ .
\end{equation}
...
$ \frac{\sigma^{2}}{n\epsilon^{2}} < \delta $. This implies that $ \frac{\sigma^{2}}{\delta\epsilon^{2}} < n $. Thus, if we sample
more than $ \frac{\sigma^{2}}{\delta\epsilon^{2}} $ data points, we can ensure that $ P(|\mathbb{E}[X] - \overline{\mu}| < \epsilon) < \delta $.
...
since we will then need fewer samples in order to estimate a close approximation to the true mean of the data-generating distribution. 
...
probability $ P(|\mathbb{E}[X] - \overline{\mu}| < \epsilon) $ reduces by a factor that is proportional to $ n $. This is to say, that we need to take
