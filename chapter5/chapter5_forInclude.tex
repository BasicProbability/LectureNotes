...
\section{Motivation}
\philip{Introduce idea of data-generating distribution somewhere here.}
...
\philip{Include reference to likelihood plots as visualisation of sample variance.}
...
Let us first explain how to compute the a MLE. By definition the the likelihood function maps the MLE to
...
\philip{Explain that log is monotone function.}
\end{Definition}
