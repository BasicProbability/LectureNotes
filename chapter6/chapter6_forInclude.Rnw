...
\begin{equation}
\theta^{(0)}_{c_{1}} = \Sexpr{params[1]} \hskip 0.5cm  \theta^{(0)}_{c_{2}} = \Sexpr{params[2]} \hskip 0.5cm  \theta^{(0)}_{c_{3}} = \Sexpr{params[3]}
\end{equation}
...
\begin{align}
&P(X_{1}=\Sexpr{data[1]} \mid Y_{1} = c_{1}) = P(X_{1}=\Sexpr{data[1]} \mid Y_{1}=c_{1},\Theta = \Sexpr{params[1]}) = \Sexpr{exampleLiks[1]}& \\
&P(X_{1}=\Sexpr{data[1]} \mid Y_{1} = c_{2}) = P(X_{1}=\Sexpr{data[1]} \mid Y_{2}=c_{2},\Theta = \Sexpr{params[2]}) = \Sexpr{exampleLiks[2]}& \nonumber \\ 
&P(X_{1}=\Sexpr{data[1]} \mid Y_{1} = c_{3}) = P(X_{1}=\Sexpr{data[1]} \mid Y_{3}=c_{3},\Theta = \Sexpr{params[3]}) = \Sexpr{exampleLiks[3]}& \nonumber
\end{align}
...
\begin{align}
&P(X_{1}=6,Y_{1} = c_{1}) = \Sexpr{priors[1]} \times P(X_{1}=\Sexpr{data[1]} \mid Y_{1}=c_{1},\Theta = \Sexpr{params[1]}) = \Sexpr{priors[1]*exampleLiks[1]} \\
&P(X_{1}=6,Y_{1} = c_{2}) = \Sexpr{priors[2]} \times P(X_{1}=\Sexpr{data[1]} \mid Y_{2}=c_{2},\Theta = \Sexpr{params[2]}) = \Sexpr{priors[2]*exampleLiks[2]} \nonumber \\ 
&P(X_{1}=6,Y_{1} = c_{3}) = \Sexpr{priors[3]} \times P(X_{1}=\Sexpr{data[1]} \mid Y_{3}=c_{3},\Theta = \Sexpr{params[3]}) = \Sexpr{priors[3]*exampleLiks[3]} \nonumber
\end{align}
...
$\E[Y=c_{j} \mid X_{1}=\Sexpr{data[1]}, \Theta = \theta^{0}] = P(Y_{1}=c_{j} \mid X_{1}=\Sexpr{data[1]}, \Theta=\theta^{0}) $. The
posterior given $ x_{1}=\Sexpr{data[1]} $ is shown below.
...
seen in the data and sum over all observed outcomes. For mixture component $ c_{1} $ (the first coin with parameter $ \theta^{0}_{c_{1}} = \Sexpr{params[1]} $) this gives
\begin{align}
\E(Y = c_{1} \mid X=x,\Theta= \theta^{0}) = \Sexpr{occurrences[1]} \times \Sexpr{posteriors[1,1]} + \Sexpr{occurrences[2]} \times \Sexpr{posteriors[2,1]} \label{eq:c1Expectation} \\ 
...
\end{align}
By parallel calculations we get $ \E(Y = c_{2}\mid X=x,\Theta= \theta^{0}) = \Sexpr{sum(binomPosteriors[,2])} $ and $ \E(Y = c_{3}\mid X=x,\Theta= \theta^{0}) = 
\Sexpr{sum(binomPosteriors[,3])} $. 
...
\begin{table}
\center
<<mixturePosterior, echo=F, results="asis", cache=T>>=
...
\begin{align}
\E[X=\Sexpr{unique_data[1]},Y=c_{1} \mid \Theta=\theta^{0}_{c^{1}}] &= \Sexpr{occurrences[1]} \times \Sexpr{posteriors[1,1]} = \Sexpr{binomPosteriors[1,1]} \\
\E[X=\Sexpr{unique_data[3]},Y=c_{3} \mid \Theta=\theta^{0}_{c^{3}}] &= \Sexpr{occurrences[3]} \times \Sexpr{posteriors[3,3]} = \Sexpr{binomPosteriors[3,3]}
\end{align} 
...
\begin{align}
P(Y=c_{1} \mid \Theta= \theta^{1}) = \Sexpr{new_weights[1]} \\
P(Y=c_{2} \mid \Theta= \theta^{1}) = \Sexpr{new_weights[2]} \nonumber \\
P(Y=c_{3} \mid \Theta= \theta^{1}) = \Sexpr{new_weights[3]} \nonumber
\end{align}
