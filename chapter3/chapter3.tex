...
\end{equation}
ways to agree on four balls with a single lottery draw. This might seem like a lot. However, if we divide this by the total number of possible sequences, we
find that $ P(X=4) = 0.000969 $ which is very little.   

We have just seen examples, were the RV would take on a specific value. We can of course also make statements
