...
random variables of interest. Since by definition the distribution has to fulfil conditions that allows us to interpret it
as a probability measure on a probability space, we can use it without worrying
about the underlying sample space. \chris{hmmm, not sure about this statement}\philip{I tried to formulate this a bit
